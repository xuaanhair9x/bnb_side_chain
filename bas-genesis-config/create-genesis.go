...
var localNetConfig = genesisConfig{
	...
	Deployers: []common.Address{
		common.HexToAddress("0x988C239e619053581624dFC99F9Ee61666754DB5"),
	},
	...
	SystemTreasury: map[common.Address]uint16{
		common.HexToAddress("0x988C239e619053581624dFC99F9Ee61666754DB5"): 10000,
	},
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0x988C239e619053581624dFC99F9Ee61666754DB5"): "0x3635c9adc5dea00000", // 1000 eth
	},
	// owner of the governance
	VotingPeriod: 20, // 1 minute
	// faucet
	Faucet: map[common.Address]string{
		common.HexToAddress("0x988C239e619053581624dFC99F9Ee61666754DB5"): "0x21e19e0c9bab2400000",
		common.HexToAddress("0x0a6A67a2D0812786567586a104F265bA1F81403A"): "0x21e19e0c9bab2400000",
		common.HexToAddress("0xaFC1F92fd4425cc1521Ac1344996884C5C006Cf5"): "0x21e19e0c9bab2400000",
	},
}
...
var devNetConfig = genesisConfig{
	...
	Validators: []common.Address{
		common.HexToAddress("0x8b35fc961a9c750C38d4aa2B812017719ddc8422"),
		common.HexToAddress("0x83bd4eeC405151c656C70322225cD973843cFAA6"),
		common.HexToAddress("0x8e4bc827E0Fd3a14661De81e167A75f52D576326"),
		common.HexToAddress("0x2d5F6D6dF3F5c3C633a378E6eDEcd7caAd8Af6c2"),
		common.HexToAddress("0xcaB196c1f3aa34135c721a14dACcCd9e21B365F5"),
		common.HexToAddress("0x4A17627020187c79f4fDe05D3e1cEea0A570e8B9"),
		common.HexToAddress("0x0510C493b1C14822039B8F75Af18CF9DB7c4F415"),
	},
	SystemTreasury: map[common.Address]uint16{
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0x8b35fc961a9c750C38d4aa2B812017719ddc8422"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x83bd4eeC405151c656C70322225cD973843cFAA6"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x8e4bc827E0Fd3a14661De81e167A75f52D576326"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x2d5F6D6dF3F5c3C633a378E6eDEcd7caAd8Af6c2"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0xcaB196c1f3aa34135c721a14dACcCd9e21B365F5"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x4A17627020187c79f4fDe05D3e1cEea0A570e8B9"): "0x3635c9adc5dea00000", // 1000 eth
		common.HexToAddress("0x0510C493b1C14822039B8F75Af18CF9DB7c4F415"): "0x3635c9adc5dea00000", // 1000 eth
	},
	// owner of the governance
	VotingPeriod: 60, // 3 minutes
	// faucet
	Faucet: map[common.Address]string{
		common.HexToAddress("0xeC4Dd6c149F3aaE3f5aBB9344d91848A333915E5"): "0x21e19e0c9bab2400000",    // governance
		common.HexToAddress("0xcd01B0C2cE23A30b0547e84F661740a34cB02665"): "0x52b7d2dcc80cd2e4000000", // faucet (10kk)
	},
}
